...
:aliases {:splint {:extra-deps {io.github.noahtheduke/splint {:mvn/version "1.24.0"}}
...
```clojure lazytest/skip=true
:profiles {:dev {:dependencies [[io.github.noahtheduke/splint "1.24.0"]]}}
...
```clojure lazytest/skip=true
:tasks {splint {:extra-deps {io.github.noahtheduke/splint {:mvn/version "1.24.0"}}
