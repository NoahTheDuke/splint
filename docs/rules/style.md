...
- [style/apply-str](#styleapply-str)
- [style/apply-str-interpose](#styleapply-str-interpose)
- [style/apply-str-reverse](#styleapply-str-reverse)
- [style/assoc-assoc](#styleassoc-assoc)
...
- [style/eq-zero](#styleeq-zero)
- [style/filter-complement](#stylefilter-complement)
- [style/filter-vec-filterv](#stylefilter-vec-filterv)
- [style/first-first](#stylefirst-first)
- [style/first-next](#stylefirst-next)
- [style/is-eq-order](#styleis-eq-order)
- [style/let-do](#stylelet-do)
- [style/mapcat-apply-apply](#stylemapcat-apply-apply)
- [style/mapcat-concat-map](#stylemapcat-concat-map)
- [style/minus-one](#styleminus-one)
- [style/minus-zero](#styleminus-zero)
- [style/multiple-arity-order](#stylemultiple-arity-order)
- [style/multiply-by-one](#stylemultiply-by-one)
- [style/multiply-by-zero](#stylemultiply-by-zero)
- [style/neg-checks](#styleneg-checks)
- [style/nested-addition](#stylenested-addition)
- [style/nested-multiply](#stylenested-multiply)
- [style/new-object](#stylenew-object)
- [style/next-first](#stylenext-first)
- [style/next-next](#stylenext-next)
- [style/not-eq](#stylenot-eq)
- [style/not-nil?](#stylenot-nil)
- [style/not-some-pred](#stylenot-some-pred)
- [style/plus-one](#styleplus-one)
- [style/plus-zero](#styleplus-zero)
- [style/pos-checks](#stylepos-checks)
- [style/prefer-boolean](#styleprefer-boolean)
- [style/prefer-clj-math](#styleprefer-clj-math)
...
- [style/trivial-for](#styletrivial-for)
- [style/update-in-assoc](#styleupdate-in-assoc)
- [style/useless-do](#styleuseless-do)
- [style/when-do](#stylewhen-do)
- [style/when-not-call](#stylewhen-not-call)
- [style/when-not-do](#stylewhen-not-do)
- [style/when-not-empty?](#stylewhen-not-empty)
- [style/when-not-not](#stylewhen-not-not)
