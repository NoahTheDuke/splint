...
```clojure
:aliases {:splint {:extra-deps {io.github.noahtheduke/splint {:mvn/version "1.23.1"}}
...
```clojure
:profiles {:dev {:dependencies [[io.github.noahtheduke/splint "1.23.1"]]}}
...
```clojure
:tasks {splint {:extra-deps {io.github.noahtheduke/splint {:mvn/version "1.23.1"}}
